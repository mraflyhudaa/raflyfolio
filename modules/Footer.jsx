...
export default function Footer() {
  ...
  return (
    <footer
      id="contact"
      className="snap-center relative z-[1] px-5 sm:px-16 md:px-28 pt-28 pb-16 text-white w-full min-h-fit flex flex-col md:flex-row gap-10 bg-dark-bg"
    >
      <form
        className="flex-[2] flex flex-col gap-5 sm:pb-16"
        name="contact"
      ...
      <aside className="flex-1 mx-6 md:pt-14 md:mx-0 pb-12 sm:pb-0">
      ...
      <div className="absolute bottom-0 left-0 w-full p-5 mt-10 text-center text-dark-headline">
